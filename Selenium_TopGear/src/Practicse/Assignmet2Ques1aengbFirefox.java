...
public class Assignmet2Ques1aengbFirefox 
{
	public static void main(String[] args) throws InterruptedException
	{
		...
		//BirthDay Day Selection 
		WebElement ListboxF11= driver.findElement(By.xpath("//select[@id='phdesktopbody_0_grs_consumer[birthdate][day]']"));
		Listbox1.click();
		Select sF11= new Select(ListboxF11);
		sF11.selectByVisibleText("11");
		
		//BirthDay Month Selection 
		 WebElement ListboxF12= driver.findElement(By.xpath("//select[@id='phdesktopbody_0_grs_consumer[birthdate][month]']"));
		 Listbox1.click();
		 Select sF12= new Select(ListboxF12);
		 sF12.selectByVisibleText("8");
		 
		//BirthDay Year Selection 
		 WebElement ListboxF13= driver.findElement(By.xpath("//select[@id='phdesktopbody_0_grs_consumer[birthdate][year]']"));
		 ListboxF13.click();
		 Select sF13= new Select(ListboxF13);
		 sF13.selectByVisibleText("1990");
